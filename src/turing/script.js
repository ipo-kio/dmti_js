    ...
    $addBtn.click(function(){
      ...
      if(!cmd.filled()){
        turing.warning($addWarn,
            ...
            $addWarn.offset().top - 60
        );
      }else if(turing.hasCommandFor(cmd.from, cmd.inp)){
        turing.warning($addWarn,
            "Команда для указанного состояния и входного символа уже есть",
            $addWarn.offset().top - 60
        );
      }else{
