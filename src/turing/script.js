  ...
  Turing.prototype.initCommandView = function () {
    ...
    for (var i = 0; i < this.groups.length; i++) {
      ...
      for (var j = 0; j < group.commands.length; j++) {
        ...
        command.makeView();
        $groupCmdView.append(command.view);
      }

      $groupView.append($groupCmdView);
